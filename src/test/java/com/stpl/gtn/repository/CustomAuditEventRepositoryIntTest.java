...
import com.stpl.gtn.GtnApp;
import com.stpl.gtn.config.Constants;
import com.stpl.gtn.config.audit.AuditEventConverter;
import com.stpl.gtn.domain.PersistentAuditEvent;
...
import static com.stpl.gtn.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
@SpringBootTest(classes = GtnApp.class)
